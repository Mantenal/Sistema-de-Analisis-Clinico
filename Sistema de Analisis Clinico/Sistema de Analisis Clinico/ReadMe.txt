========================================================================
    APLICACIÓN DE CONSOLA: Sistema de Analisis Clinico Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Sistema de Analisis Clinico.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Sistema de Analisis Clinico.


Sistema de Analisis Clinico.vcxproj
...
Sistema de Analisis Clinico.vcxproj.filters
...
Sistema de Analisis Clinico.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Sistema de Analisis Clinico.pch y un archivo de tipos precompilados llamado StdAfx.obj.
